...
- Framework-neutral structured plots with validated JSON import, 11 plot families, consistent log transforms and histogram/box semantics, series visibility, and JSON/SVG/PNG/PDF/interactive HTML export
