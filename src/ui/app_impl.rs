...
impl eframe::App for ForgeApp {
    ...
    fn save(&mut self, storage: &mut dyn eframe::Storage) {
        ...
        let state = SessionState {
            ...
            python_environment_fingerprint: self.python.environment_fingerprint.clone(),
            ...
            drift_mean_shift_threshold: self.drift.mean_shift_threshold,
            drift_scale_ratio_lower: self.drift.scale_ratio_lower,
            drift_scale_ratio_upper: self.drift.scale_ratio_upper,
            native_training_backend: self.deep_backend,
            compute_device: self.compute_device,
            native_training_epochs: self.burn.training_epochs,
            native_training_learning_rate: self.burn.training_learning_rate,
            native_training_validation_fraction: self.burn.training_validation_fraction,
            native_training_patience: self.early_stopping_patience,
            native_training_use_dataset: self.burn.training_use_dataset,
            native_training_feature: self.burn.training_feature.clone(),
            native_training_target: self.burn.training_target.clone(),
            dock_layout: self
                .dock_tree
                .as_ref()
