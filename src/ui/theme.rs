...
pub fn extra_builtin_themes() -> Vec<NamedTheme> {
    ...
    vec![
        ...
        theme(
            "One Dark Pro",
            [40, 44, 52], [44, 49, 58], [58, 63, 75], [33, 37, 43],
            [62, 68, 81], [171, 178, 191], [127, 132, 142], [97, 175, 239], true,
        ),
        theme(
            "Tokyo Night",
            [26, 27, 38], [36, 40, 59], [47, 51, 77], [22, 22, 30],
            [59, 66, 97], [192, 202, 245], [86, 95, 137], [122, 162, 247], true,
        ),
        theme(
            "Monokai",
            [39, 40, 34], [45, 46, 39], [62, 61, 50], [30, 31, 26],
            [73, 72, 62], [248, 248, 242], [117, 113, 94], [166, 226, 46], true,
        ),
        theme(
            "Night Owl",
            [1, 22, 39], [11, 41, 66], [14, 58, 92], [1, 14, 26],
            [29, 59, 83], [214, 222, 235], [99, 119, 119], [130, 170, 255], true,
        ),
        theme(
            "Cobalt2",
            [25, 53, 73], [30, 65, 94], [13, 58, 88], [18, 39, 56],
            [35, 78, 110], [255, 255, 255], [139, 159, 177], [255, 198, 0], true,
        ),
        // Bold / novelty themes.
        theme(
            "Crimson",
            [23, 14, 16], [34, 22, 26], [48, 31, 36], [15, 9, 11],
            [90, 46, 55], [242, 228, 230], [181, 142, 149], [230, 57, 80], true,
        ),
        theme(
            "Matrix",
            [0, 0, 0], [6, 18, 6], [12, 31, 12], [0, 0, 0],
            [28, 74, 28], [51, 224, 90], [31, 154, 68], [0, 255, 65], true,
        ),
        theme(
            "Hacker",
            [10, 6, 0], [21, 14, 2], [36, 25, 6], [0, 0, 0],
            [92, 68, 15], [255, 176, 0], [181, 125, 10], [255, 204, 51], true,
        ),
        theme(
            "Solarized Light",
